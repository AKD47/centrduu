		...
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post();?>
			...
			<div class="clubs__item">
				...
				<div class="clubs__item--right">
					...
					if(!empty($phone)):?>
						<a href="tel:<?php echo $phone; ?>" class="clubs__item--tel">телефон: <?php echo $phone; ?></a>
					<?php endif; ?>
					<?php $email = fw_get_db_post_option(get_the_ID(),'email');
					if(!empty($email)):?>
						<a href="mailto:<?php echo $email; ?>" class="clubs__item--tel">e-mail: <?php echo $email; ?></a>
					<?php endif; ?>
					...
					if($vk !== '#'):?>
						<a href="<?php echo $vk; ?>" class="clubs__item--social" target="_blank"><i class="fa fa-vk" aria-hidden="true"></i></a>
					<?php endif; ?>
				</div>
